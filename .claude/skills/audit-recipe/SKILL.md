...
Review an existing recipe for common issues: missing dependencies, incorrect
...
Verify the recipe's dependency lists:
...
find build/<recipe>/destdir -type f -executable | head -5
```
